...
/**
 * @title UniStake V1
 * @dev Forked from https://github.com/heypran/crosschain-swap-hook  "learning about ccip Integration/ will use pattern to send messages using layerZero."
 * Modified for cross-chain liquid staking functionality
 */
...
contract uniStakeV1 is BaseHook {
    ...
    function _unlockCallback(
        ...
        uniStakeSwapParams memory data = abi.decode(
            rawData,
            (uniStakeSwapParams)
        );
